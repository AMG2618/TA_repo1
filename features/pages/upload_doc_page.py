...
#     INPUT_DATE = (By.NAME, "data")
#     BUTTON_INCARCA = (By.XPATH, '//input[@type="submit" and @value="Incarca"]')
#     UPLOAD_MESSAGE = (By.XPATH, "//p[contains(text(), 'A fost incarcat: UploadTestDoc.pdf de tipul diploma_emc')]")
#
#     def open(self):
#         self.driver.get(USER_PAGE)
#
...
#         success_message = self.driver.find_element(By.XPATH, "//p[contains(text(), 'A fost incarcat: UploadTestDoc.pdf de tipul diploma_emc')]").text
